...
#show: thesis.with(
  ...
  achievement: [
    参与面向云边端协同的芯粒结构与系统软件（项目编号：2023YFB4503100）.国家重点研发计划共性关键技术类专项. 2023.11——2026.10. 作为项目/课题骨干，参与项目的调研、申请、实施阶段，主要围绕云边端跨域分布式训练场景下的通信瓶颈问题开展了系统性研究，提出了低比特量化压缩、分层流水线集合通信调度以及计算与通信重叠等关键优化方法，并完成了系统的设计与验证。
